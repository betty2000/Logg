...
public class CountBMI extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            String w = sharedPreferences.getString("width" , "0");
            ...
            TextView ldia = (TextView)findViewById(R.id.tv5);// 取得 顯示診斷 物件
            ldia.setText( ldia.getText() +  sharedPreferences.getString("BMI" , ""));
            sharedPreferences.edit().putString("BMI" ,nf.format(fw/fh) ).apply();
            // 診斷結果 顯示
            if (fresult<18.5)
                dia.setText("體重過輕");
